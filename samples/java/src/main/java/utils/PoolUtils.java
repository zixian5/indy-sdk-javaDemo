...
public class PoolUtils {
	...
	private static final String DEFAULT_POOL_NAME = "pool3";
	...
	public static String createPoolLedgerConfig() throws IOException, InterruptedException, java.util.concurrent.ExecutionException, IndyException {
		...
		String json = createPoolLedgerConfigJSONParameter.toJson();
		Pool.createPoolLedgerConfig(DEFAULT_POOL_NAME, json).get();
